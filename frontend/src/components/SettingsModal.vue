        ...
        <div>
          ...
          <div class="relative">
            <textarea
              ...
              placeholder="sk-xxxx"
              rows="4"
              class="w-full px-4 py-2.5 bg-white border border-surface-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all pr-10 font-mono"
            />
            <button
              @click="showApiKey = !showApiKey"
              class="absolute right-3 top-3 text-content-muted hover:text-content-secondary"
            >
          ...
          <p class="mt-1 text-xs text-content-muted">支持多个密钥，每行一个，仅存储在本地浏览器中，自动轮询使用</p>
        </div>
